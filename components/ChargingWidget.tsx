      ...
      >
        ...
        <View style={styles.content}>
            ...
            >
              <View style={styles.lightningWrap}>
                {Array.from({ length: theme.lightningCount }).map((_, idx) => (
                  <View
                    key={idx}
                    style={{ marginLeft: idx > 0 ? -10 : 0, zIndex: idx }}
                  >
          ...
          <View style={styles.info}>
            <View style={styles.titleRow}>
              ...
              {state.mode === "HPC" && (
                <View
                  style={[styles.ultraBadge, { backgroundColor: theme.accent }]}
                >
        ...
        {state.isFinishing && (
          ...
          >
            ...
            <Text
              style={[styles.title, { color: colors.text, marginLeft: 10 }]}
            >
              Finishing Charge Session...
            </Text>
          </View>
        )}
      </Pressable>
